  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${BASE_URL}/adding-manga`, {
        ...
        body: JSON.stringify({
          ...formData,
          lastChapterRead: formData.lastChapterRead ? parseFloat(formData.lastChapterRead) : 0,
          latestChapter: formData.latestChapter ? parseFloat(formData.latestChapter) : 0,
    ...
    <div className={`popup-overlay ${isOpen ? "active" : ""}`}>
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            <label htmlFor="latestChapterDate">
              Latest Chapter Available Date
            </label>
            <input
              type="date"
